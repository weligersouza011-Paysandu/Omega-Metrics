(function () {
  ...
  var STATUS_CONFIG = {
    ...
    ABSENTEISMO: {
      lista: ["FALTA SEM JUSTIFICATIVA", "ATESTADO MÉDICO", "ATESTADO DE ÓBITO", "DECLARAÇÃO", "BO", "ÓBITO", "LICENÇA CASAMENTO", "LICENÇA PATERNIDADE"],
    ...
    ISENCAO: {
      lista: ["COMPENSAÇÃO", "FÉRIAS", "FOLGA", "EXAME PERIÓDICO", "LICENÇA MATERNIDADE", "INSS", "AGUARDANDO CRACHÁ", "TREINAMENTO", "FERIADO", "AGUARDANDO MOBILIZAÇÃO SGC", "TRANSFERÊNCIA"],
